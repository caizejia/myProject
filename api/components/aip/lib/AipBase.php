...
namespace api\components\aip\lib;

use api\components\aip\lib\AipHttpClient;
use api\components\aip\lib\AipBCEUtil;
...
class AipBase {
    ...
    public function __construct(){
        ...
        $this->appId = trim(\Yii::$app->params['baiduAppId']);
        $this->apiKey = trim(\Yii::$app->params['baiduAppKey']);
        $this->secretKey = trim(\Yii::$app->params['baiduSecretKey']);
