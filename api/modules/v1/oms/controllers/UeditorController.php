...
use api\components\Uploader;

/**
 * Ueditor controller for the `v1` module.
 */
class UeditorController extends Controller
{
    ...
    {
        $CONFIG = json_decode(preg_replace("/\/\*[\s\S]+?\*\//", '', file_get_contents(Yii::getAlias('@api/config').'/ueditor_config.json')), true);
    ...
    public function actionCrawler($action, $CONFIG)
    {
        /* 上传配置 */
        $config = array(
